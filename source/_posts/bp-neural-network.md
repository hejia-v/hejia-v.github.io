...
&= -\frac{1}{m} \Biggl[ \sum_{i=1}^m \biggl[ \frac{\partial}{\partial \ W_{[l]t}} \biggl( 1\{ y^{(i)} = l \} \ log\ a_{[l]}  \biggl) +  \frac{\partial}{\partial \ W_{[l]t}} \biggl( \sum_{j=1,j \neq l}^k 1\{ y^{(i)} = j \} \ log\ a_{[j]} \biggr) \biggl] \Biggl] \\
&= -\frac{1}{m} \Biggl[ \sum_{i=1}^m \biggl[ 1\{ y^{(i)} = l \} \biggl( \frac{\partial \ (log\ a_{[l]}) }{\partial \ a_{[l]}} \cdot \frac{\partial \ a_{[l]}}{\partial \ z_{[l]}} \cdot \frac{\partial \ z_{[l]}}{\partial \ W_{[l]t}}  \biggl) +  \biggl( \sum_{j=1,j \neq l}^k 1\{ y^{(i)} = j \} \cdot \frac{\partial \ (log\ a_{[j]}) }{\partial \ a_{[j]}} \cdot \frac{\partial \ a_{[j]}}{\partial \ z_{[l]}} \cdot \frac{\partial \ z_{[l]}}{\partial \ W_{[l]t}} \biggr)  \biggl] \Biggl] \\
...
\end{align}
$$
输出层的第$l$个节点的偏置$b_{[l]}$的求导(梯度)为：TODO: 加上上标(样本号)
$$
\begin{align}
...
&= -\frac{1}{m} \Biggl[ \sum_{i=1}^m \biggl[ \frac{\partial}{\partial \ b_{[l]}} \biggl( 1\{ y^{(i)} = l \} \ log\ a_{[l]}  \biggl) +  \frac{\partial}{\partial \ b_{[l]}} \biggl( \sum_{j=1,j \neq l}^k 1\{ y^{(i)} = j \} \ log\ a_{[j]} \biggr) \biggl] \Biggl] \\
&= -\frac{1}{m} \Biggl[ \sum_{i=1}^m \biggl[ 1\{ y^{(i)} = l \} \biggl( \frac{\partial \ (log\ a_{[l]}) }{\partial \ a_{[l]}} \cdot \frac{\partial \ a_{[l]}}{\partial \ z_{[l]}} \cdot \frac{\partial \ z_{[l]}}{\partial \ b_{[l]}}  \biggl) +  \biggl( \sum_{j=1,j \neq l}^k 1\{ y^{(i)} = j \} \cdot \frac{\partial \ (log\ a_{[j]}) }{\partial \ a_{[j]}} \cdot \frac{\partial \ a_{[j]}}{\partial \ z_{[l]}} \cdot \frac{\partial \ z_{[l]}}{\partial \ b_{[l]}} \biggr)  \biggl] \Biggl] \\
&= -\frac{1}{m} \Biggl[ \sum_{i=1}^m \biggl[ 1\{ y^{(i)} = l \} \biggl( \frac{1}{a_{[l]}} \cdot a_{[l]} ( 1-a_{[l]} ) \cdot 1 \biggl) +  \biggl( \sum_{j=1,j \neq l}^k 1\{ y^{(i)} = j \} \cdot \frac{1}{a_{[j]}} \cdot (-a_{[j]} a_{[l]}) \cdot 1 \biggr)  \biggl] \Biggl] \\
...
$$
\begin{align}
\delta_{[l]}^{(i)} &= \frac{\partial \ loss^{(i)} }{\partial \ z_{[l]}^{(i)}} = \frac{\partial}{ \partial \ z_{[l]}^{(i)} } \biggl[ \sum_{j=1}^k 1\{ y^{(i)} = j \} \ log\ a_{[j]}^{(i)}  \biggl]  = 1\{ y^{(i)} = l \} - a_{[l]}^{(i)} \\
...
&= \frac{\partial}{ \partial \ W^{[1]}_{[l]t} } \bigl( \frac{1}{m} \sum_{i=1}^m loss^{(i)} \bigr) \\
&= \frac{1}{m} \sum_{i=1}^m \biggl[ \frac{\partial}{ \partial \ W^{[1]}_{[l]t} } loss^{(i)} \biggr] \\
&= \frac{1}{m} \sum_{i=1}^m \biggl[ \frac{\partial \ loss^{(i)}}{ \partial \ a^{[1]}_{[l]} } \cdot \frac{\partial \ a^{[1]}_{[l]}}{\partial \ z^{[1]}_{[l]}} \cdot \frac{\partial \ z^{[1]}_{[l]}}{\partial \ W^{[1]}_{[l]t}} \biggr] \\
&= \frac{1}{m} \sum_{i=1}^m \biggl[ \frac{\partial \ loss^{(i)}}{ \partial \ z^{[2](i)}_{[l]} } \cdot \frac{\partial \ z^{[2](i)}_{[l]} }{ \partial \ a^{[1]}_{[l]} } \cdot \frac{\partial \ a^{[1]}_{[l]}}{\partial \ z^{[1]}_{[l]}} \cdot \frac{\partial \ z^{[1]}_{[l]}}{\partial \ W^{[1]}_{[l]t}} \biggr] \\

&= \frac{1}{m} \sum_{i=1}^m \biggl[ \frac{\partial \ loss^{(i)}}{ \partial \ z^{[2](i)}_{[l]} } \cdot \frac{\partial \ z^{[2](i)}_{[l]} }{ \partial \ a^{[1]}_{[l]} } \cdot (1 - z_{[l]}^{[1](i)} ) \cdot x_t^{(i)} \biggr] \\

&= \bigl( \frac{\partial}{ \partial a_{[l]}^{[1]} } \bigl( \frac{1}{m} \sum_{i=1}^m loss^{(i)} \bigr) \bigr) \cdot (1 - z_{[1]}^{(i)} ) \cdot x_{t} \\
\end{align}
$$
